...
### List Financial Data Tables

```
GET https://da.platform.claira.io/v2/credit_analysis/deals/{deal_id}/fin_data_tables/
Authorization: Bearer <access_token>
```
  ...
  "data": [
    {
      ...
      "category": "doc_id_fin_data",
      "created_at": "2023-09-22T17:58:11"
    }
  ]
}
```

### Get Financial Data Table (with data)

```
GET https://da.platform.claira.io/v2/credit_analysis/deals/{deal_id}/fin_data_tables/{table_id}/
Authorization: Bearer <access_token>
```
    ...
    "fin_data": [
      {
        "id": "item-uuid-1",
        "category": "revenue",
        "metric_type": "Q4 2024 LTM",
        "value": "125,000",
        "unit": "$",
        "financial_metric_type": "LTM",
        "financial_metric_date": "2024-12-31"
      }
    ]
  }
}
